...
/* #define MUSTARD_DATA_TUPLE_VISIT_IMPL(GetImpl)                                                                        \
    if constexpr (L > R) {                                                                                            \
        throw std::out_of_range{PrettyException(fmt::format("Index {} out of range", i))};                            \
    } else {                                                                                                          \
        ...
        if (i == idx) {                                                                                               \
            ...
            throw std::invalid_argument(PrettyException(fmt::format("The function provided is not invocable with {}", \
                                                                    typeid(*GetImpl).name())));                       \
        } else if (i < idx) {                                                                                         \
