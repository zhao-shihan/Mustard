...
CPMFindPackage(
    ...
    OPTIONS "EIGEN_BUILD_TESTING ${MUSTARD_BUILD_EXTERNAL_TESTING}"
...
CPMFindPackage(
    ...
    OPTIONS "YAML_CPP_BUILD_TOOLS OFF"
            ...
            "YAML_CPP_BUILD_TESTS ${MUSTARD_BUILD_EXTERNAL_TESTING}"
...
CPMFindPackage(
    ...
    OPTIONS "BACKWARD_SHARED OFF"
            "BACKWARD_INSTALL ON"
            "BACKWARD_TESTS ${MUSTARD_BUILD_EXTERNAL_TESTING}")
...
if(MUSTARD_USE_MIMALLOC)
    CPMFindPackage(
        ...
        OPTIONS "MI_OVERRIDE OFF"
                ...
                "MI_BUILD_SHARED OFF"
                "MI_BUILD_OBJECT OFF"
                "MI_BUILD_TESTS ${MUSTARD_BUILD_EXTERNAL_TESTING}")
endif()
