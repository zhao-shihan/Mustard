...
if(NOT MUSTARD_BUILTIN_ENVPARSE)
    find_package(envparse ${MUSTARD_ENVPARSE_MINIMUM_REQUIRED} QUIET)
    if(NOT envparse_FOUND)
        set(MUSTARD_BUILTIN_ENVPARSE ON)
        message(NOTICE "***Notice: envparse not found (minimum required is ${MUSTARD_ENVPARSE_MINIMUM_REQUIRED}). Turning on MUSTARD_BUILTIN_ENVPARSE")
    endif()
endif()
...
if(MUSTARD_BUILTIN_ENVPARSE)
    ...
    if(NOT EXISTS "${MUSTARD_BUILTIN_ENVPARSE_SRC_DIR}/CMakeLists.txt")
        ...
        message(FATAL_ERROR "It seems that the download of envparse is not successful. You can try to run cmake again, or manually download envparse from ${MUSTARD_BUILTIN_ENVPARSE_URL} and extract it to ${MUSTARD_PROJECT_3RDPARTY_DIR} (and keep the directory structure). If the error persists, you can try to clean the build tree and restart the build.")
    endif()
endif()
