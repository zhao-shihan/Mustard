...
if(MUSTARD_BUILTIN_YAML_CPP)
    ...
    if(NOT EXISTS "${MUSTARD_BUILTIN_YAML_CPP_SRC_DIR}/CMakeLists.txt")
        ...
        message(FATAL_ERROR "It seems that the download of yaml-cpp is not successful. You can try to run cmake again, or manually download yaml-cpp from ${MUSTARD_BUILTIN_YAML_CPP_URL} and extract it to ${MUSTARD_PROJECT_3RDPARTY_DIR} (and keep the directory structure). If the error persists, you can try to clean the build tree and restart the build.")
    endif()
endif()
