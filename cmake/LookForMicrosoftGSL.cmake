...
if(MUSTARD_BUILTIN_MSGSL)
    ...
    if(NOT EXISTS "${MUSTARD_BUILTIN_MSGSL_SRC_DIR}/CMakeLists.txt")
        ...
        message(FATAL_ERROR "It seems that the download of Microsoft.GSL is not successful. You can try to run cmake again, or manually download Microsoft.GSL from ${MUSTARD_BUILTIN_MSGSL_URL} and extract it to ${MUSTARD_PROJECT_3RDPARTY_DIR} (and keep the directory structure). If the error persists, you can try to clean the build tree and restart the build.")
    endif()
endif()
