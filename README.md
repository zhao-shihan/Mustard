...
8. [zhao-shihan/MPL (A C++17 message passing library based on MPI)](https://github.com/zhao-shihan/mpl) (≥ 0.8.0, built-in if not found)
9. [muc (A standard non-standard C++ library)](https://github.com/zhao-shihan/muc) (≥ 0.25.628, built-in if not found)
