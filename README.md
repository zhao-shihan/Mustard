...
1. [argparse (Argument Parser for Modern C++)](https://github.com/p-ranav/argparse) (≥ 3.1, built-in if not found)
...
6. [fmt (A modern formatting library)](https://github.com/fmtlib/fmt) (≥ 11.1.0, built-in if not found)
7. [muc (A standard non-standard C++ library)](https://github.com/zhao-shihan/muc) (main, built-in if not found)
8. [Microsoft.GSL](https://github.com/Microsoft/GSL) ([ISO C++ guidelines support library](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#gsl-guidelines-support-library)) (≥ 4.0.0, built-in if not found)
