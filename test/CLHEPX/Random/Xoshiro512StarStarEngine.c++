...
int main() {
    ...
    std::cout << "    CLHEPX::...::Xoshiro512StarStarEngine : " << time << " ms (last integer: " << r << ')' << std::endl;
    ...
    time = stopwatch.read();
    std::cout << "     Math::...::Xoshiro512StarStar : " << time << " ms (last integer: " << r << ')' << std::endl;
    ...
    time = stopwatch.read();
    std::cout << "    CLHEPX::...::Xoshiro512StarStarEngine : " << time << " ms (last displacement: " << std::setprecision(18) << v2d << std::setprecision(6) << ')' << std::endl;
    ...
    time = stopwatch.read();
    std::cout << "     Math::...::Xoshiro512StarStar : " << time << " ms (last displacement: " << std::setprecision(18) << v2d << std::setprecision(6) << ')' << std::endl;
    ...
    time = stopwatch.read();
    std::cout << "    CLHEPX::...::Xoshiro512StarStarEngine : " << time << " ms (last displacement: " << std::setprecision(18) << v3d << std::setprecision(6) << ')' << std::endl;
    ...
    time = stopwatch.read();
    std::cout << "     Math::...::Xoshiro512StarStar : " << time << " ms (last displacement: " << std::setprecision(18) << v3d << std::setprecision(6) << ')' << std::endl;
    ...
    time = stopwatch.read();
    std::cout << "    CLHEPX::...::Xoshiro512StarStarEngine : " << time << " ms (last displacement: " << std::setprecision(18) << v4d << std::setprecision(6) << ')' << std::endl;
    ...
    time = stopwatch.read();
    std::cout << "     Math::...::Xoshiro512StarStar : " << time << " ms (last displacement: " << std::setprecision(18) << v4d << std::setprecision(6) << ')' << std::endl;
