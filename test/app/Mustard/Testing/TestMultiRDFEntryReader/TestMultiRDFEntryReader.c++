...
TestMultiRDFEntryReader::TestMultiRDFEntryReader() :
    Subprogram{"TestMultiRDFEntryReader", "Test Mustard::Data::RDFEntryReader<Ms...>."} {}

auto TestMultiRDFEntryReader::Main(int argc, char* argv[]) const -> int {
