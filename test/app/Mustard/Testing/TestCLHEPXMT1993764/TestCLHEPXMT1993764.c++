...
auto TestCLHEPXMT1993764::Main(int /*argc*/, char* /*argv*/[]) const -> int {
    ...
    PrintLn("    CLHEPX::...::MT1993764Engine : {} ms (last integer: {})", time, r);
    ...
    time = stopwatch.read();
    PrintLn("       Math::...::MT1993764 : {} ms (last integer: {})", time, r);
    ...
    time = stopwatch.read();
    PrintLn("    CLHEPX::...::MT1993764Engine : {} ms (last displacement: {})", time, v2d);
    ...
    time = stopwatch.read();
    PrintLn("       Math::...::MT1993764 : {} ms (last displacement: {})", time, v2d);
    ...
    time = stopwatch.read();
    PrintLn("    CLHEPX::...::MT1993764Engine : {} ms (last displacement: {})", time, v3d);
    ...
    time = stopwatch.read();
    PrintLn("       Math::...::MT1993764 : {} ms (last displacement: {})", time, v3d);
    ...
    time = stopwatch.read();
    PrintLn("    CLHEPX::...::MT1993764Engine : {} ms (last displacement: {})", time, v4d);
    ...
    time = stopwatch.read();
    PrintLn("       Math::...::MT1993764 : {} ms (last displacement: {})", time, v4d);
