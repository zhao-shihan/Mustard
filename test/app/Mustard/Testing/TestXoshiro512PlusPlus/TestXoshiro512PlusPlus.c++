...
TestXoshiro512PlusPlus::TestXoshiro512PlusPlus() :
    Subprogram{"TestXoshiro512PlusPlus", "Test Mustard::Random::Xoshiro512PlusPlus and benchmark."} {}

auto TestXoshiro512PlusPlus::Main(int argc, char* argv[]) const -> int {
